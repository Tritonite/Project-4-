...
public class DataTable extends JPanel{
    ...
    /**
     * 
     * @param data Mapdata object where the statistics will be from 
     * @param type the type of Enumeration in Statstype class (Ex. MAXIMU, MINIMUM etc)
     * @param paramId The datatype (Ex. tair,ta9m etc.)
